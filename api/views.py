...
from rest_framework import viewsets,request,status # viewsets: perform all crud operations on a model
...
class MealViewset(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])   # function for bussines logic, with viewset for extra actions 
